...
import { TrendingUp, TrendingDown, DollarSign, Target, Trophy, History, Trash2, ChevronDown, ChevronRight } from 'lucide-react';
                ...
                >
                  ...
                  <div className="space-y-2 mb-2">
                    {prediction.matches.map((match) => {
                      ...
                      return (
                      <div key={match.id} className={`bg-gray-900 rounded p-2 border ${
                        matchResult === 'won' ? 'border-green-600/50' :
                        matchResult === 'lost' ? 'border-red-600/50' : 'border-gray-800'
                      }`}>
                          ...
                          <div className="flex items-center space-x-2 flex-1">
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center gap-2">
                                ...
                                {matchScore && (
                                  <span className="text-xs px-1.5 py-0.5 bg-gray-700 rounded text-white font-bold">
                                    {matchScore}
                                  </span>
                                )}
                                {matchResult === 'won' && (
                              ...
                              <div className="flex items-center gap-2">
                                {competition && (
                                  <span className="text-xs px-1.5 py-0.5 bg-gray-800 rounded text-gray-300">{competition}</span>
                                )}
                                <span className="text-xs text-gray-400">{match.bet_type}</span>
                              </div>
